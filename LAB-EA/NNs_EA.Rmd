...
#data <- generate_data(3000, 0.8, 0.1, 0.1, hardness = 1, noisy = 1)
#data <- generate_data(3000, 0.8, 0.1, 0.1, hardness = 1, noisy = 5)
#data <- generate_data(3000, 0.8, 0.1, 0.1, hardness = 0, noisy = 1)
data <- generate_data(3000, 0.8, 0.1, 0.1, hardness = 0, noisy = 5)
...
```{r}
print(rbind(back_ga, ga_ga, es_es), row.names = FALSE)
```

```{r}
kable(rbind(back_ga, ga_ga, es_es), 'latex', booktabs = TRUE, row.names = FALSE)
```
